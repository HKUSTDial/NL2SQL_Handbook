...
3. Hexgen-Flow: Optimizing LLM Inference Request Scheduling for Agentic Text-to-SQL. <img src="https://img.shields.io/badge/ICDE'2026-green"> [<img src="https://img.shields.io/badge/Paper-grey">](https://arxiv.org/abs/2505.05286) [<img src="https://img.shields.io/badge/Code-grey">](https://github.com/Relaxed-System-Lab/Hexgen-Flow)
4. LEAF-SQL: Level-wise Exploration with Adaptive Fine-graining for Text-to-SQL Skeleton Prediction. <img src="https://img.shields.io/badge/ICDE'2026-green">  [<img src="https://img.shields.io/badge/Code-grey">](https://github.com/Atlamtiz/LEAF-SQL)
5. An Efficient and Effective Evaluator for Text2SQL Models on Unseen and Unlabeled Data. <img src="https://img.shields.io/badge/ICDE'2026-green">
6. Boosting Small Language Models for Text-to-SQL with Fine-Grained Execution Feedback and Cost-Efficient Rewards. <img src="https://img.shields.io/badge/ICDE'2026-green"> [<img src="https://img.shields.io/badge/Paper-grey">](https://arxiv.org/abs/2512.18622)
7. SQLMorph: Query Mutation and Fine-Grained Metrics for Text-to-SQL Evaluation. <img src="https://img.shields.io/badge/ICDE'2026-green"> [<img src="https://img.shields.io/badge/Code-grey">](https://github.com/dais-polymtl/sqlmorph)
8. MM2SQL: A Benchmark and Method for Visually-Grounded SQL Generation. <img src="https://img.shields.io/badge/ICDE'2026-green"> 
9. Text2SQL-Flow: A Robust SQL-Aware Data Augmentation Framework for Text-to-SQL. <img src="https://img.shields.io/badge/ICDE'2026-green"> [<img src="https://img.shields.io/badge/Paper-grey">](https://arxiv.org/abs/2511.10192)
10. Knapsack Optimization-based Schema Linking for LLM-based Text-to-SQL Generation. <img src="https://img.shields.io/badge/ICDE'2026-green"> [<img src="https://img.shields.io/badge/Paper-grey">](https://arxiv.org/abs/2502.12911)
11. CYANSQL: Unlock the Power of NL2SQL via Clustering-based Test-Time Scaling. <img src="https://img.shields.io/badge/ICDE'2026-green">
12. Beyond Static Pipelines: Learning Dynamic Workflows for Text-to-SQL. <img src="https://img.shields.io/badge/arXiv'2026-purple"> [<img src="https://img.shields.io/badge/Paper-grey">](https://arxiv.org/abs/2504.15077) [<img src="https://img.shields.io/badge/Code-grey">](https://github.com/Satissss/SquRL)
13. Think2SQL: Blueprinting Reward Density and Advantage Scaling for Effective Text-to-SQL Reasoning.  <img src="https://img.shields.io/badge/arXiv'2026-purple"> [<img src="https://img.shields.io/badge/Paper-grey">]([https://arxiv.org/abs/2504.15077](https://arxiv.org/pdf/2602.15564)) [<img src="https://img.shields.io/badge/Code-grey">](https://anonymous.4open.science/r/Think2SQL-3B7F/README.md)
